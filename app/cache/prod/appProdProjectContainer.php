...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fos_elastica.finder.electro_el_atoui.product' => 'getFosElastica_Finder_ElectroElAtoui_ProductService',
            'fos_elastica.index.electro_el_atoui' => 'getFosElastica_Index_ElectroElAtouiService',
            'fos_elastica.index.electro_el_atoui.product' => 'getFosElastica_Index_ElectroElAtoui_ProductService',
            'fos_elastica.index.electro_el_atoui.product.serializer.callback' => 'getFosElastica_Index_ElectroElAtoui_Product_Serializer_CallbackService',
            ...
            'fos_elastica.object_persister.electro_el_atoui.product' => 'getFosElastica_ObjectPersister_ElectroElAtoui_ProductService',
            ...
            'fos_elastica.provider.electro_el_atoui.product' => 'getFosElastica_Provider_ElectroElAtoui_ProductService',
            ...
            'fos_elastica.serializer' => 'getFosElastica_SerializerService',
        ...
        $this->aliases = array(
            ...
            'fos_elastica.index' => 'fos_elastica.index.electro_el_atoui',
            ...
            'fos_rest.serializer' => 'fos_elastica.serializer',
            'fos_rest.templating' => 'templating',
            'fos_user.util.username_canonicalizer' => 'fos_user.util.email_canonicalizer',
            'jms_serializer' => 'fos_elastica.serializer',
            'mailer' => 'swiftmailer.mailer.default',
            'serializer' => 'fos_elastica.serializer',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventSubscriber(new \FOS\ElasticaBundle\Doctrine\Listener($this->get('fos_elastica.object_persister.electro_el_atoui.product'), array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'preRemove', 3 => 'postFlush'), $this->get('fos_elastica.indexable'), array('identifier' => 'id', 'indexName' => 'electro_el_atoui', 'typeName' => 'product'), NULL));
        $a->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'electro_atoui', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\ElectroAtoui\\CoreBundle\\Entity'))), 'ElectroAtoui\\CoreBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('CoreBundle' => 'ElectroAtoui\\CoreBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1ac0fa345549fdd2493df1d0bdf328ffc4a2fac10288ad3c95e430a3d4d8cfbe');
        return $instance;
    }
    ...
    {
        return $this->services['fos_elastica.config_manager'] = new \FOS\ElasticaBundle\Configuration\ConfigManager(array(0 => new \FOS\ElasticaBundle\Configuration\Source\ContainerSource(array('electro_el_atoui' => array('elasticsearch_name' => 'electro_el_atoui', 'reference' => $this->get('fos_elastica.index.electro_el_atoui'), 'name' => 'electro_el_atoui', 'settings' => array(), 'type_prototype' => array(), 'use_alias' => false, 'types' => array('product' => array('name' => 'product', 'mapping' => array('dynamic_templates' => array(), 'properties' => array('id' => array('type' => 'integer'), 'quantity' => array('type' => 'integer'), 'price' => array('type' => 'float'), 'sale_price' => array('type' => 'float'), 'for_sale' => array('type' => 'boolean'), 'is_active' => array('type' => 'boolean'), 'reference' => array(), 'name' => array('boost' => 7), 'slug' => array('boost' => 7), 'description' => array('boost' => 3), 'images' => array('type' => 'nested', 'properties' => array('name' => array('boost' => 5))), 'categories' => array('type' => 'nested', 'properties' => array('name' => array('boost' => 5))))), 'config' => array('persistence' => array('driver' => 'orm', 'model' => 'ElectroAtoui\\CoreBundle\\Entity\\Product', 'identifier' => 'id', 'provider' => array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => false, 'query_builder_method' => 'createQueryBuilder'), 'listener' => array('insert' => true, 'update' => true, 'delete' => true, 'flush' => true, 'immediate' => false, 'logger' => false), 'finder' => array(), 'elastica_to_model_transformer' => array('hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder'), 'model_to_elastica_transformer' => array()), 'serializer' => array('groups' => array()), 'index_analyzer' => NULL, 'search_analyzer' => NULL))))))));
    }
    ...
    protected function getFosElastica_Finder_ElectroElAtoui_ProductService()
    {
        $a = new \FOS\ElasticaBundle\Doctrine\ORM\ElasticaToModelTransformer($this->get('doctrine'), 'ElectroAtoui\\CoreBundle\\Entity\\Product', array('hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder', 'identifier' => 'id'));
        $a->setPropertyAccessor($this->get('fos_elastica.property_accessor'));
        return $this->services['fos_elastica.finder.electro_el_atoui.product'] = new \FOS\ElasticaBundle\Finder\TransformedFinder($this->get('fos_elastica.index.electro_el_atoui.product'), $a);
    }
    protected function getFosElastica_Index_ElectroElAtouiService()
    {
        return $this->services['fos_elastica.index.electro_el_atoui'] = $this->get('fos_elastica.client.default')->getIndex('electro_el_atoui');
    }
    protected function getFosElastica_Index_ElectroElAtoui_ProductService()
    {
        $this->services['fos_elastica.index.electro_el_atoui.product'] = $instance = $this->get('fos_elastica.index.electro_el_atoui')->getType('product');
        $instance->setSerializer(array(0 => $this->get('fos_elastica.index.electro_el_atoui.product.serializer.callback'), 1 => 'serialize'));
        return $instance;
    }
    protected function getFosElastica_IndexManagerService()
    {
        $a = $this->get('fos_elastica.index.electro_el_atoui');
        return $this->services['fos_elastica.index_manager'] = new \FOS\ElasticaBundle\Index\IndexManager(array('electro_el_atoui' => $a), $a);
    }
    ...
    protected function getFosElastica_Manager_OrmService()
    {
        ...
        $instance->addEntity('ElectroAtoui\\CoreBundle\\Entity\\Product', $this->get('fos_elastica.finder.electro_el_atoui.product'));
        return $instance;
    }
    ...
    protected function getFosElastica_ObjectPersister_ElectroElAtoui_ProductService()
    {
        $a = new \FOS\ElasticaBundle\Transformer\ModelToElasticaIdentifierTransformer(array('identifier' => 'id'));
        $a->setPropertyAccessor($this->get('fos_elastica.property_accessor'));
        return $this->services['fos_elastica.object_persister.electro_el_atoui.product'] = new \FOS\ElasticaBundle\Persister\ObjectSerializerPersister($this->get('fos_elastica.index.electro_el_atoui.product'), $a, 'ElectroAtoui\\CoreBundle\\Entity\\Product', array(0 => $this->get('fos_elastica.index.electro_el_atoui.product.serializer.callback'), 1 => 'serialize'));
    }
    ...
    protected function getFosElastica_Provider_ElectroElAtoui_ProductService()
    {
        return $this->services['fos_elastica.provider.electro_el_atoui.product'] = new \FOS\ElasticaBundle\Doctrine\ORM\Provider($this->get('fos_elastica.object_persister.electro_el_atoui.product'), $this->get('fos_elastica.indexable'), 'ElectroAtoui\\CoreBundle\\Entity\\Product', array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => false, 'query_builder_method' => 'createQueryBuilder', 'indexName' => 'electro_el_atoui', 'typeName' => 'product'), $this->get('doctrine'));
    }
    protected function getFosElastica_ProviderRegistryService()
    {
        ...
        $instance->addProvider('electro_el_atoui', 'product', 'fos_elastica.provider.electro_el_atoui.product');
        return $instance;
    }
    protected function getFosElastica_ResetterService()
    {
        return $this->services['fos_elastica.resetter'] = new \FOS\ElasticaBundle\Index\Resetter($this->get('fos_elastica.config_manager'), $this->get('fos_elastica.index_manager'), $this->get('fos_elastica.alias_processor'), $this->get('fos_elastica.mapping_builder'));
    }
    protected function getFosElastica_SerializerService()
    {
    ...
    {
        return $this->services['jms_serializer.templating.helper.serializer'] = new \JMS\SerializerBundle\Templating\SerializerHelper($this->get('fos_elastica.serializer'));
    }
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('cache' => array('quality' => 100, 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'filters' => array(), 'post_processors' => array()), 'produitThumb' => array('quality' => 80, 'filters' => array('thumbnail' => array('size' => array(0 => 300, 1 => 150), 'mode' => 'inset')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'produit' => array('quality' => 75, 'filters' => array('thumbnail' => array('size' => array(0 => 470, 1 => 310), 'mode' => 'inset')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array())));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \JMS\Serializer\Twig\SerializerExtension($this->get('fos_elastica.serializer')));
    ...
    protected function getFosElastica_Index_ElectroElAtoui_Product_Serializer_CallbackService()
    {
        $this->services['fos_elastica.index.electro_el_atoui.product.serializer.callback'] = $instance = new \FOS\ElasticaBundle\Serializer\Callback();
        $instance->setSerializer($this->get('fos_elastica.serializer'));
        $instance->setGroups(array());
        return $instance;
    }
