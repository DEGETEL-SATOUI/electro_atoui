 ...
 */
class UserDocument extends \ElectroAtoui\CoreBundle\Entity\UserDocument implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\UserDocument' . "\0" . 'id', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\UserDocument' . "\0" . 'updateAt', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\UserDocument' . "\0" . 'user', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\UserDocument' . "\0" . 'name', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\UserDocument' . "\0" . 'path', 'file');
        }
