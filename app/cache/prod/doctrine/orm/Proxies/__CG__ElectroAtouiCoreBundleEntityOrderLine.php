 ...
 */
class OrderLine extends \ElectroAtoui\CoreBundle\Entity\OrderLine implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\OrderLine' . "\0" . 'order', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\OrderLine' . "\0" . 'product', 'quantity');
        }
