 ...
 */
class Image extends \ElectroAtoui\CoreBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Image' . "\0" . 'updateAt', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Image' . "\0" . 'product', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Image' . "\0" . 'name', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Image' . "\0" . 'path', 'file');
        }
