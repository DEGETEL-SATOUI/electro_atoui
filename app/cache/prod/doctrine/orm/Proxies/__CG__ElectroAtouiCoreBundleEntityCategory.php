 ...
 */
class Category extends \ElectroAtoui\CoreBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Category' . "\0" . 'products', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Category' . "\0" . 'childrens', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Category' . "\0" . 'parent', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Category' . "\0" . 'path', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Category' . "\0" . 'slug', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\Category' . "\0" . 'description', 'file');
        }
