 ...
 */
class User extends \ElectroAtoui\CoreBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\User' . "\0" . 'orders', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\User' . "\0" . 'shipping_addresses', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\User' . "\0" . 'documents', '' . "\0" . 'ElectroAtoui\\CoreBundle\\Entity\\User' . "\0" . 'profile', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function getShippingAddresses()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getShippingAddresses', array());
    ...
    public function addShippingAddress(\ElectroAtoui\CoreBundle\Entity\ShippingAddress $shipping_address)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addShippingAddress', array($shipping_address));

        return parent::addShippingAddress($shipping_address);
    }
    ...
    public function removeShippingAddress(\ElectroAtoui\CoreBundle\Entity\ShippingAddress $shipping_address)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeShippingAddress', array($shipping_address));

        return parent::removeShippingAddress($shipping_address);
    }
